...
class Test_Class_Fuctions extends WP_UnitTestCase
{
    ...
    public function testAdminOptions()
    {
        ...
        $this->assertStringContainsString('Durianpay Payment Gateway', $result);
        $this->assertStringContainsString('Allows payments by Credit/Debit Cards, NetBanking, and multiple Wallets', $result);
