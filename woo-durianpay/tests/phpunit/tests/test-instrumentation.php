...
class Test_Instrumentation extends WP_UnitTestCase
{
    ...
    {
        $this->assertSame(10, has_action('activate_' . basename(PLUGIN_DIR) . '/woo-durianpay.php',
            [$this->rzpInstrumentationObj, 'razorpayPluginActivated']));
        $this->assertSame(10, has_action('deactivate_' . basename(PLUGIN_DIR) . '/woo-durianpay.php',
